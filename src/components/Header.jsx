    ...
    <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 transition-colors duration-200">
      <div className="flex justify-between items-center">
        ...
        <div className="text-center">
          <h1 className="text-xl font-semibold text-gray-800 dark:text-white">Chat with BRO EXPLAINS</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Your Simple Explanation Companion</p>
        </div>
        <button
          onClick={onClear}
          className="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
